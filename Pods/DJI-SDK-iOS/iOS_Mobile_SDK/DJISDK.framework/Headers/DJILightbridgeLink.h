...
/**
 *  Sets the percentage downlink video bandwidth dedicated to the FPV camera. The
 *  remaining percentage is dedicated to  the camera on the HD Gimbal. Setting 100%
 *  dedicates all the video bandwidth to FPV.
 *  
...
/**
 *  Gets the percentage downlink video bandwidth dedicated to the FPV camera. The
 *  remaining percentage is dedicated to  the camera on the HD Gimbal. Setting 100%
 *  dedicates all the video bandwidth to FPV.
 *  
...
/**
 *  Sets the computational power and bandwidth balance between AV and HMDI inputs on
...
/**
 *  Gets the computational power and bandwidth balance between AV and HMDI inputs on
