 ...
 *  @param completion Completion block that will be called when the operator succeeds or fails to stop  the mission. If it fails, an error will be returned.
 */
- (void)setAngularVelocity:(NSInteger)angularVelocity compeletion:(DJICompletionBlock)completion;
 ...
 *  @param completion Completion block that will be called when the operator succeeds or fails to stop  the mission. If it fails, an error will be returned.
 */
- (void)resetMissionHeadingWithCompeletion:(DJICompletionBlock)completion;
 ...
 */
+ (NSInteger)maxAngularVelocityForRadius:(float)radius;
