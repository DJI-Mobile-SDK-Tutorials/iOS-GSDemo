...
/**
 *  These methods are used to contact Mission Control to notify it of  Timeline
 *  element execution. Mission Control will wait for updates  from the Timeline
 *  element before it itself progresses. This  protocol is not intended to be
 *  implemented by any other object and is provided purely for the  information of
 *  how to interface with Mission Control.
 */
...
typedef NS_ENUM(NSInteger, DJIMissionControlError) {
    ...
    /**
     *  Can't pause an element which is not pausbile.  This error doesn't is
     *  informational and doesn't impact Timeline.
     */
    DJIMissionControlTimelineErrorCantPauseUnpausableElement = 10001,
